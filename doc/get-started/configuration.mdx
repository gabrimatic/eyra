...
Most users should start with `eyra setup` and `eyra doctor`. Edit `.env` directly only when you want a specific provider, model, sandbox root, or optional capability gate.
