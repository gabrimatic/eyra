...
| `eyra menu` | Launch the native macOS menu bar developer preview when available |
| `eyra menu --json` | Report menu bar availability, install mode, Swift requirement, and fallback command |
| `eyra-menu` | Launch the same menu bar preview from the standalone console script |
