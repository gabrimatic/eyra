...
- Homebrew formula status: private beta scaffold until a tagged asset and checksum exist.
...
- No secrets or local identity fixtures beyond approved public project metadata.
...
- Confirm branch target is `master` for this repo unless changed upstream.
