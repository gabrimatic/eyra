...
- Delegation: specialist agents run only as optional workers.
...
It can integrate those systems as workers. Eyra still owns route policy, approval, privacy, task lifecycle, logs, cancellation, and final status.
