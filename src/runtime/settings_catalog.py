...
SETTING_SPECS: tuple[SettingSpec, ...] = (
    ...
    SettingSpec("MEMORY_AUTO_SAVE_ENABLED", "Memory auto-save", "Allow Eyra to save compact durable facts from likely preference/profile turns.", "Memory", "true", True, "Only short local key/value facts are stored; raw conversations and secrets are rejected.", value_type="bool", allowed_values=("true", "false")),
    SettingSpec("MEMORY_WRITE_REQUIRE_CONFIRMATION", "Memory write confirmation", "Require confirmation before automatic non-explicit memory saves.", "Memory", "false", True, "Explicit remember commands still save immediately because the user directly requested them.", value_type="bool", allowed_values=("true", "false")),
